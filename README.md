...
###Converting spectral data file from .raw to .ms2 using [ProteoWizard's](http://proteowizard.sourceforge.net/)
...
3. Convert *MS_QC_120min_PreviouslyAcquiredDataset.raw* to .ms2 format using *msconvert* from [ProteoWizard](http://proteowizard.sourceforge.net/) or other file conversion software. (See instructions above for [file conversion](https://github.com/LavalleeAdamLab/MealTimeMS/edit/master/README#L35))
